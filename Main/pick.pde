...
float dz=-2000;                                 // distance to camera. Manipulated with wheel or when 's' is pressed and mouse moved
...
void doPick()
{
  ...
  fill(grey, 100); 
  showShadow(F, 3); // magenta translucent shadow of focus point (after moving it up with 'F'
